...
test('login with incorrect account one time', async ({page})=>{
...
test('login with incorrect password one time', async ({page})=>{
    const loginPage = new LoginPage(page);
...
test('login with incorrect account 3rd time', async ({page})=>{
    const loginPage = new LoginPage(page);
