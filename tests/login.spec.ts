...
test('login script 1', async ({page})=>{
    ...
    // fill login form
        loginPage.submitLoginForm('k11123', 'Pass123', {page})
    ...
    await expect(page.locator("(//div[@id='account-login']//div)[1]")).toHaveText(" Warning: No match for E-Mail Address and/or Password.")
})